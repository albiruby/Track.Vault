...
if (checkWarmup) {
  ...
  let wuPass = checkWarmup.title !== 'Warm-up Routine Support Routine 1' && !/Support Routine 1/i.test(checkWarmup.title) && !!checkWarmup.slug && checkWarmup.createdBy === 'Track.Vault Curated Library';
...
if (checkCooldown) {
  ...
  let cdPass = checkCooldown.title !== 'Cooldown Routine Support Routine 1' && !/Support Routine 1/i.test(checkCooldown.title) && !!checkCooldown.slug && checkCooldown.createdBy === 'Track.Vault Curated Library';
