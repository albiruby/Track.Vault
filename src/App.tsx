...
export default function App() {
 ...
 className="w-40 xl:w-52 py-1.5 px-3 text-sm bg-white border border-[#E2E8F0] rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-600 placeholder:text-slate-400 font-medium text-slate-800 shadow-sm"
 />
 </div>
 </div>
 ...
 <p className="text-sm font-bold text-slate-800 ">Workout Slug Not Found</p>
 ...
 <div>
 <strong className="text-slate-900 ">Strict Static Catalog:</strong> The baseline workout catalog is fully static. Storing files as indexed, frozen JSON arrays guarantees lighting-fast response speeds, 100% offline uptime, and pristine preservation of workout parameters.
 </div>
 </li>
 <li className="flex items-start gap-2.5 flex-row">
 <span className="text-blue-600 font-bold text-lg leading-none">⚡</span>
 <div>
 <strong className="text-slate-900 ">Absolute Local Sandbox Security:</strong> We run no background telemetry trackers, API synchronization, or cloud cookies. Because we collect no custom user details, saved workout profiles remain entirely locked inside your browser.
 </div>
 </li>
 <li className="flex items-start gap-2.5 flex-row">
 <span className="text-blue-600 font-bold text-lg leading-none">⚡</span>
 <div>
 <strong className="text-slate-900 ">Modern Share Canvas:</strong> Physical exercise schedules copy directly into clean Markdown, or render into gorgeous PNG graphics optimized for lockscreens or Strava maps without relying on complex backend layers.
 </div>
 </li>
 </ul>
 </div>
