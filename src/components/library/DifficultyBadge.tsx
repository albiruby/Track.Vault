...
export function DifficultyBadge({ difficulty }: DifficultyBadgeProps) {
  const getSubtleStyles = () => {
    ...
    if (dStr.includes("easy") || dStr === "1" || dStr === "2" || dStr === "3") {
      ...
      return "bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-950/20 dark:text-blue-400 dark:border-blue-900/35";
    } else {
      return "bg-orange-50 text-orange-700 border-orange-200 dark:bg-orange-950/10 dark:text-orange-300 dark:border-orange-900/25";
    }
  };
