...
export function WorkoutNotesEditor({
 ...
 <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-slate-850 flex items-center gap-2">
 ...
 className="flex-1 p-2 bg-slate-50 border border-[#E2E8F0] text-xs rounded-xl focus:outline-none focus:ring-1 focus:ring-blue-500/20 text-slate-800 "
 />
 <button
 type="submit"
 className="p-2 bg-blue-600 text-white hover:bg-blue-700 rounded-xl text-xs transition-colors cursor-pointer"
 >
 ...
 <li key={index} className="flex items-start justify-between gap-2 p-2 bg-slate-50/50 text-xs rounded-xl border border-slate-100 ">
 ...
 {/* Common mistakes */}
 <div className="bg-white border border-[#E2E8F0] rounded-3xl p-5 space-y-4 shadow-sm">
 <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-slate-850 flex items-center gap-2">
