    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-[#334155] rounded-2xl p-6 space-y-4 shadow-sm">
        <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-[#0F172A] dark:text-[#F8FAFC] flex items-center gap-2">
          <Activity className="w-4 h-4 text-sky-500" /> Basic Information
        </h3>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Workout Title *</label>
            <input
              type="text"
              required
              value={workout.title || ""}
              ...
              className="w-full p-2.5 bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155] text-sm rounded-xl text-[#0F172A] dark:text-[#F8FAFC] focus:outline-none font-sans font-semibold"
            />
          </div>

          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Short Card Title *</label>
            <input
              type="text"
              required
          ...
          <div className="md:col-span-2 space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Session Summary / Purpose *</label>
            <textarea
              required
              rows={2}
      ...
      <div className="bg-white dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-[#334155] rounded-2xl p-6 space-y-4 shadow-sm">
        <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-[#0F172A] dark:text-[#F8FAFC] flex items-center gap-2">
          <Award className="w-4 h-4 text-sky-500" /> Profiling & Distances
        </h3>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Primary Distance *</label>
            <input
              type="text"
              required
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Target Categories (Comma Separated)</label>
            <input
              type="text"
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Library Category Module *</label>
            <select
              value={workout.category || ""}
              onChange={(e) => handleFieldChange("category", e.target.value)}
              className="w-full p-2.5 bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155] text-sm rounded-xl text-slate-700 dark:text-slate-300 focus:outline-none font-sans font-semibold cursor-pointer"
            >
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Athlete Target Level *</label>
            <select
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Training Phase</label>
            <select
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Running Surface</label>
            <select
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Core Difficulty (1-10 Slider) *</label>
            <div className="flex items-center gap-3">
              <input
                ...
                className="flex-1 accent-sky-500 select-none cursor-pointer"
              />
              <span className="w-8 text-right font-mono text-sm font-black text-sky-500">
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Est. Total Duration (mins) *</label>
            <input
              type="number"
              min="5"
              required
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Est. Total Distance (km) *</label>
            <input
              type="number"
              step="0.1"
              required
      ...
      <div className="bg-white dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-[#334155] rounded-2xl p-6 space-y-4 shadow-sm">
        <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-[#0F172A] dark:text-[#F8FAFC] flex items-center gap-2">
          <ShieldAlert className="w-4 h-4 text-sky-500" /> Musculoskeletal Risk Assessment
        </h3>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Injury Risk Tier</label>
            <select
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Why are we flagged at this tier?</label>
            <input
              type="text"
      ...
      <div className="bg-white dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-[#334155] rounded-2xl p-6 space-y-4 shadow-sm">
        <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-[#0F172A] dark:text-[#F8FAFC] flex items-center gap-2">
          <Grid3X3 className="w-4 h-4 text-sky-500" /> Intended Intensity Target Rules
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Main Set Target Intensity</label>
            <input
              type="text"
              ...
              className="w-full p-2.5 bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155] text-sm rounded-xl focus:outline-none font-sans font-semibold text-[#0F172A] dark:text-[#F8FAFC]"
            />
          </div>

          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-600 dark:text-slate-355">Warm-up / Cooldown Intensity</label>
            <input
              type="text"
