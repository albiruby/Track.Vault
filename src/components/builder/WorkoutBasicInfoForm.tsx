...
export function WorkoutBasicInfoForm({
 ...
 <Activity className="w-4 h-4 text-blue-600" /> Basic Information
 </h3>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Workout Title *</label>
 <input
 type="text"
 required
 value={workout.title || ""}
 ...
 className="w-full p-2.5 bg-[#F8FAFC] border border-[#E2E8F0] text-sm rounded-xl text-[#0F172A] focus:outline-none font-sans font-semibold"
 />
 </div>

 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Short Card Title *</label>
 <input
 type="text"
 required
 ...
 <label className="text-xs font-bold text-slate-600 ">Session Summary / Purpose *</label>
 <textarea
 required
 rows={2}
 ...
 <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 space-y-4 shadow-sm">
 <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-[#0F172A] flex items-center gap-2">
 <Award className="w-4 h-4 text-blue-600" /> Profiling & Distances
 </h3>

 <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Primary Distance *</label>
 <input
 type="text"
 required
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Target Categories (Comma Separated)</label>
 <input
 type="text"
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Library Category Module *</label>
 <select
 value={workout.category || ""}
 onChange={(e) => handleFieldChange("category", e.target.value)}
 className="w-full p-2.5 bg-[#F8FAFC] border border-[#E2E8F0] text-sm rounded-xl text-slate-700 focus:outline-none font-sans font-semibold cursor-pointer"
 >
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Athlete Target Level *</label>
 <select
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Training Phase</label>
 <select
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Running Surface</label>
 <select
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Core Difficulty (1-10 Slider) *</label>
 ...
 className="flex-1 accent-blue-600 select-none cursor-pointer"
 />
 <span className="w-8 text-right font-mono text-sm font-black text-blue-600">
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Est. Total Duration (mins) *</label>
 <input
 type="number"
 min="5"
 required
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Est. Total Distance (km) *</label>
 <input
 type="number"
 step="0.1"
 required
 ...
 <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 space-y-4 shadow-sm">
 <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-[#0F172A] flex items-center gap-2">
 <ShieldAlert className="w-4 h-4 text-blue-600" /> Musculoskeletal Risk Assessment
 </h3>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Injury Risk Tier</label>
 <select
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Why are we flagged at this tier?</label>
 <input
 type="text"
 ...
 <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 space-y-4 shadow-sm">
 <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-[#0F172A] flex items-center gap-2">
 <Grid3X3 className="w-4 h-4 text-blue-600" /> Intended Intensity Target Rules
 </h3>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Main Set Target Intensity</label>
 <input
 type="text"
 ...
 className="w-full p-2.5 bg-[#F8FAFC] border border-[#E2E8F0] text-sm rounded-xl focus:outline-none font-sans font-semibold text-[#0F172A]"
 />
 </div>

 <div className="space-y-1">
 <label className="text-xs font-bold text-slate-600 ">Warm-up / Cooldown Intensity</label>
 <input
 type="text"
